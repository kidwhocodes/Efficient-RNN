...
def test_stats_by_strategy_basic(tmp_path):
    ...
    rows = [
        ...
        {"task": "synthetic", "strategy": "l1_unstructured", "amount": 0.1, "post_acc": 0.65, "delta_post_acc": 0.05, "sparsity": 0.2},
        {"task": "synthetic", "strategy": "l1_unstructured", "amount": 0.1, "post_acc": 0.66, "delta_post_acc": 0.04, "sparsity": 0.2},
    ]
...
def test_pairwise_deltas(tmp_path):
    ...
    rows = [
        ...
        {"task": "synthetic", "strategy": "l1_unstructured", "amount": 0.1, "seed": 0, "post_acc": 0.65},
        {"task": "synthetic", "strategy": "noise_prune", "amount": 0.1, "seed": 1, "post_acc": 0.71},
        {"task": "synthetic", "strategy": "l1_unstructured", "amount": 0.1, "seed": 1, "post_acc": 0.64},
    ]
    pd.DataFrame(rows).to_csv(csv_path, index=False)
    df = load_experiment_records(str(csv_path))
